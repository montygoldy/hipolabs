...
const RenderHeader = ({ headerType, venueInfo }) => {
  ...
  switch (headerType) {
    ...
    case "venues":
      template = (
        <div className="header-container u-margin-bottom-m">
          <div className="header-content">
            <div className="home-logo u-margin-bottom-l">
              <Link to="/">
                <img
                  src="/image/logo/logo-venue.png"
                  alt="logo"
                  className="home-logo__image"
                />
              </Link>
    ...
    case "venueDetail":
      template = (
        <div className="venue-detail-header u-margin-bottom-m">
          {
            <React.Fragment>
                ...
                <div className="venue-info-content">
                  ...
                  <div className="right-side">
                    <div className="rating">
                      <span className="rating-text">{venueInfo.rating}</span>
                    </div>
                  </div>
                </div>
              </div>
